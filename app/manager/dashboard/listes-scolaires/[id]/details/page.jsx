    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <div className="flex space-x-2">
          ...
          <Button 
            variant="outline"
            className="flex items-center text-blue-600 hover:text-blue-700 border-blue-600 hover:border-blue-700"
            onClick={() => router.push(`/manager/dashboard/listes-scolaires/${id}/validate`)}
          >
            <CheckCircle2 className="mr-2 h-4 w-4" />
          ...
          <Button 
            variant="outline"
            className="flex items-center text-amber-600 hover:text-amber-700 border-amber-600 hover:border-amber-700"
