...
export default function NewListeScolairePage() {
  ...
  const addBesoin = () => {
    setFormData((prev) => ({
      ...prev,
      besoins: [...prev.besoins, { nomProduit: "", quantite: 1, details: "" }]
    }));
  };
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      toast.success("Liste scolaire créée avec succès");
      router.push("/manager/dashboard/listes-scolaires");
    } catch (error) {
      console.error("Erreur:", error);
      toast.error("Impossible de créer la liste scolaire");
    } finally {
  ...
  return (
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-2xl font-bold">Nouvelle Liste Scolaire</CardTitle>
          <CardDescription>
            Créez une nouvelle liste de fournitures scolaires pour une classe
          </CardDescription>
        </CardHeader>
