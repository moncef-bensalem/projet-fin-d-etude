  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        ...
        <button 
          onClick={() => router.push("/manager/listes-scolaires/new")}
                      ...
                      <td className="p-4 text-right">
                        <div className="flex justify-end space-x-2">
                          <button
                            ...
                            onClick={() =>
                              router.push(`/manager/listes-scolaires/${liste.id}/details`)
                            }
                          ...
                          <button
                            ...
                            onClick={() =>
                              router.push(`/manager/listes-scolaires/${liste.id}/edit`)
                            }
                            title="Modifier"
                          >
